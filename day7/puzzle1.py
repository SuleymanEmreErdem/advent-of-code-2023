...
def compare_hands(hand1, hand2):
    card_str = {'A': 14, 'K': 13, 'Q': 12, 'J': 11, 'T': 10, '9': 9, '8': 8, '7': 7, '6': 6, '5': 5, '4': 4, '3': 3, '2': 2}
...
for hand in file:
    ...
    for card in hand[0]:
        if card in card_count:
            ...
            card_count[card] = 1
    types[set_types(sorted(card_count.items(), key=lambda item: item[1], reverse=True))].append(tuple(hand))
